        ...
        <div className="fixed inset-0 bg-black bg-opacity-30  backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-2 rounded">
            ...
            <div className="flex flex-col">
              {accounts.map((a, idx) => (
                <div
                  key={idx}
                  onClick={() => {
                    dispatch(setCurrUser(a));
                    dispatch(changeSelectSeatPop(false));
                  }}
            ...
            <div className="flex justify-center my-1">
              <button
                className="px-6 py-2 mx-2 bg-red-600 text-white mt-6 border-2 border-red-600 hover:bg-white hover:text-red-600 "
                onClick={() => dispatch(changeSelectSeatPop(false))}
              >
                Close
              </button>
            </div>
