  ...
  return (
    <div>
      <div className="flex justify-center">
        <h1 className="font-bold text-2xl md:mt-4 text-gray-800 md:block -mr-16 hidden mt-16">
          <span className="text-[#402d6a]">Menu</span>
        </h1>
      </div>
      {popup.filterPop && (
        <div className="fixed inset-0 bg-black bg-opacity-30  flex justify-center ">
          <div className=" bg-white flex md:flex-row rounded-xl h-[60%] w-2/3 flex-col md:flex-wrap md:justify-center px-4 mx-4 mt-16 md:mt-0">
            <h3 className="md:hidden block mt-2 text-xl font-semibold">
              Filter
            </h3>
            ...
            <div
              onClick={() => {
                ...
                dispatch(changeFilterPop(false));
                paginate(1);
              }}
